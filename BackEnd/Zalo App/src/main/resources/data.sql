...
insert ignore into user values(4,'2002-12-17','2002-12-17',"Nguyễn Hồng Hạnh","DefaultAvatar.jpg","DefaultCoverAvatar.jpg",true,false,'2002-12-17',"$2a$12$D0xTq0HXSEMj7Vb86VMDwO4Q99bPi07ZwQbgmcKBLdoTeLqqmp0Ea","0968322777","Female", "OFFLINE", '2002-12-17');
...
INSERT ignore INTO `zaloapp`.`friends` (`user_id_1`, `user_id_2`, `friend_from`, `friend_status`, `nick_name_from_user1`, `nick_name_from_user2`, `send_invite_by`) VALUES ('1', '2', '2002-12-25 00:00:00', 'IsFriend', 'Thoại', 'Nam', b'0');
INSERT ignore INTO `zaloapp`.`friends` (`user_id_1`, `user_id_2`, `friend_from`, `friend_status`, `nick_name_from_user1`, `nick_name_from_user2`, `send_invite_by`) VALUES ('1', '3', '2002-12-25 00:00:00', 'IsFriend', 'Số 3', 'Giang Nam', b'1');
INSERT ignore INTO `zaloapp`.`friends` (`user_id_1`, `user_id_2`, `friend_from`, `friend_status`, `send_invite_by`) VALUES ('3', '4', '2002-12-25 00:00:00', 'WaitingAccept', b'0');

INSERT ignore INTO `zaloapp`.`group_chat` (`id`, `group_name`, `is_change_name_and_avatar`, `is_create_new_note`, `is_create_new_poll`, `is_pin_message`, `is_send_message`, `avatar`) VALUES ('1', 'Group1', b'0', b'0', b'0', b'0', b'1', 'DefaultAvatar.jpg');
...
(`id`, `content`, `deleted`, `disable_actions`, `disable_reactions`, `failure`, `saved`, `seen`, `send_at`, `updated_at`, `group_id`, `user_id`, `distributed`, `is_system`)
VALUES
    (5, 'Do you want to go to the cinema?', b'0', b'0', b'0', b'0', b'1', b'1', '2024-05-16 12:08:00', '2024-05-16 12:08:00', 1, 1, b'1', b'0');

INSERT ignore INTO `zaloapp`.`message_chat`
(`id`, `content`, `deleted`, `disable_actions`, `disable_reactions`, `failure`, `saved`, `seen`, `send_at`, `updated_at`, `group_id`, `user_id`, `distributed`, `is_system`)
VALUES
    (6, 'Yes, when and where will we meet?', b'0', b'0', b'0', b'0', b'1', b'1', '2024-05-16 12:09:00', '2024-05-16 12:09:00', 1, 2, b'1', b'0');

INSERT ignore INTO `zaloapp`.`message_chat`
(`id`, `content`, `deleted`, `disable_actions`, `disable_reactions`, `failure`, `saved`, `seen`, `send_at`, `updated_at`, `group_id`, `user_id`, `distributed`, `is_system`)
VALUES
    (7, 'Tomorrow, 9 AM. I will see u at the bus stop near your house', b'0', b'0', b'0', b'0', b'1', b'1', '2024-05-16 12:10:00', '2024-05-16 12:10:00', 1, 1, b'1', b'0');

INSERT ignore INTO `zaloapp`.`message_chat`
(`id`, `content`, `deleted`, `disable_actions`, `disable_reactions`, `failure`, `saved`, `seen`, `send_at`, `updated_at`, `group_id`, `user_id`, `distributed`, `is_system`)
VALUES
    (8, 'Okay', b'0', b'0', b'0', b'0', b'1', b'1', '2024-05-16 12:11:00', '2024-05-16 12:11:00', 1, 2, b'1', b'0');

INSERT ignore INTO `zaloapp`.`message_chat`
(`id`, `content`, `deleted`, `disable_actions`, `disable_reactions`, `failure`, `saved`, `seen`, `send_at`, `updated_at`, `group_id`, `user_id`, `distributed`, `is_system`)
VALUES
    (9, 'Okay, see u later. Bye', b'0', b'0', b'0', b'0', b'1', b'1', '2024-05-16 12:12:00', '2024-05-16 12:12:00', 1, 1, b'1', b'0');
...
UPDATE ignore `zaloapp`.`message_chat` SET `reply_message_id` = '5' WHERE (`id` = '6');
UPDATE ignore `zaloapp`.`message_chat` SET `reply_message_id` = '6' WHERE (`id` = '7');
UPDATE ignore `zaloapp`.`message_chat` SET `reply_message_id` = '9' WHERE (`id` = '10');