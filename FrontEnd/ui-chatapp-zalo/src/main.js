...
import {
    ...
    faUserTag, faLock, faUserMinus, faShare, faEarthAmericas, faCamera, faBan
...
library.add(faUserSecret, faCommentDots, faAddressBook, faToolbox, faGear, faCloud, faMagnifyingGlass, faSquareCheck, faUserPlus,
    ...
    faEllipsisVertical, faPenToSquare, faImages, faUserTag, faLock, faUserMinus, faShare, faEarthAmericas, faCamera, faBan
)
